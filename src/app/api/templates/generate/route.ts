...
import { initDatabase, saveTemplate } from "../../../../lib/db";
...
/**
 * POST handler for generating and saving a new template in the background
...
export async function POST(request: NextRequest) {
  ...
  generateAndSaveTemplate().catch((error) => {
...
/**
 * Generates a template and saves it to the database
 * This runs asynchronously in the background
 */
async function generateAndSaveTemplate(): Promise<void> {
